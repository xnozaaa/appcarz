        ...
        <section className="bg-app-carz-background-primary py-20 lg:py-28">
          <div className="container">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-app-carz-text-primary/80">
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogPosts.map((post, index) => (
                ...
                >
                  <div className="h-48 bg-gradient-to-br from-app-carz-background-primary to-app-carz-primary/20" />
                  
                  <div className="p-6">
                    <div className="flex items-center gap-4 text-sm text-app-carz-text-tertiary mb-3">
                      <span className="bg-app-carz-primary/10 text-app-carz-primary px-3 py-1 rounded-full font-medium">
                        {post.category}
                      </span>
                    ...
                    <h2 className="text-xl font-semibold text-app-carz-text-secondary mb-3 group-hover:text-app-carz-primary transition-colors">
                      {post.title}
                    </h2>

                    <p className="text-app-carz-text-tertiary mb-4 line-clamp-3">
                      {post.excerpt}
                    </p>

                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm text-app-carz-text-tertiary">
                      ...
                      <Link 
                        href={`/blog/${post.slug}`}
                        className="flex items-center gap-2 text-app-carz-primary hover:gap-3 transition-all font-medium"
                      >
                        Read More
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input 
                  ...
                  className="flex-1 px-6 py-4 rounded-lg text-app-carz-text-secondary focus:outline-none focus:ring-2 focus:ring-app-carz-primary"
                />
                <button className="btn-text bg-white text-app-carz-text-secondary px-8 py-4 rounded-lg hover:bg-white/90 transition-colors whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
